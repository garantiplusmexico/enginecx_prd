...
**Siguiente tarea: T-S05** — el helper que traduce el token al asesor y la documentación de autorización. Todo lo que necesita está listo: el rol `"Asesor Farmer"` existe en `AspNetRoles`, el usuario de prueba lo tiene, y su perfil está sembrado.
